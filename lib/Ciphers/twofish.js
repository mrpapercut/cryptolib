...
var functionUtils = function functionUtils() {
...
exports.twofish = function twofish(IV) {
        ...
        makeKey = function makeKey(aKey) {
            ...
            if (aKey &&
                ...
                var keyLenght = aKey.length,
                    tmpKey = [],
                    index = 0,
                    nValue, limitedKey, k64Cnt = keyLenght / 8,
    ...
    if (!IV) {
        ...
        initializingVector = new Uint8Array(IV);
    } else if (IV && utils.isAnArray(IV) && IV.length > BLOCK_SIZE) {
