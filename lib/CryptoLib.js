...
exports.DES        = new BlockCipher()._createHelper(new DES().algo());
exports.TripleDes  = new BlockCipher()._createHelper(new TripleDes().algo());

exports.Rabbit     = new StreamCipher()._createHelper(new Rabbit().algo());
exports.RC4        = new StreamCipher()._createHelper(new RC4().algo());
exports.RC4Drop    = new StreamCipher()._createHelper(new RC4Drop().algo());
